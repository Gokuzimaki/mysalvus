function initSliderMain(container,type,slideholdref){
	jQuery(document).ready(function ($) {
            /*Slide Show transition Control*/
            ...
            _CaptionTransitions["RTTJDN1|L"] = {$Duration:1200,x:0.5,$Zoom:6,$Rotate:0.25,$Easing:{$Left:$JssorEasing$.$EaseOutJump,$Zoom:$JssorEasing$.$EaseInCubic,$Opacity:$JssorEasing$.$EaseLinear,$Rotate:$JssorEasing$.$EaseOutWave},$Opacity:2,$Round:{$Rotate:0.5}}
            var options = {
            ...
            function ScaleSlider() {
                ...
                // var realwidth  =Math.floor($('#'+container+'').width());
                // $('div'+slideholdref+'').css("width",+"px");
                // console.log(realwidth," the real width");
                if (bodyWidth)
