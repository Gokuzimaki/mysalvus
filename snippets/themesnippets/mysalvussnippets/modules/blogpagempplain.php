<?php
	// this file ia an alternate to the blogpagemultipleparser.php file
	// major difference here is that pagination is not handled and all expected output
	// are transfered to a $output variable	
